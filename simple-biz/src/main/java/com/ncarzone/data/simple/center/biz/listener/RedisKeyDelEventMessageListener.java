...
public class RedisKeyDelEventMessageListener extends KeyspaceEventMessageListener implements
    ...
    public RedisKeyDelEventMessageListener(RedisMessageListenerContainer listenerContainer) {
